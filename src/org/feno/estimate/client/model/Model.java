...
public abstract class Model {
	...
	public HashMap<String, PosteriorSample> samplePosteriorToo(int steps, RandomGenerator rng) {
	...
	public HashMap<String, Float64ArrayNative> samplePosterior(int steps, RandomGenerator rng) {
