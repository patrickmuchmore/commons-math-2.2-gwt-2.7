...
//    interpolatedState = (double[]) interpolator.interpolatedState.clone();
      currentState = ArrayUtil.cloneDouble(interpolator.currentState);
      interpolatedState = ArrayUtil.cloneDouble(interpolator.interpolatedState);
    } else {
      currentState      = null;
      interpolatedState = null;
    }
...
//  return (double[]) interpolatedState.clone();
    return ArrayUtil.cloneDouble(interpolatedState);
  }
